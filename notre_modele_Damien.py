...
def main():
    ...
    trainloader = DataLoader(train_data, batch_size=200, shuffle=True, pin_memory=True, num_workers=2)
    valloader = DataLoader(val_data, batch_size=200, shuffle=False, pin_memory=True, num_workers=2)
